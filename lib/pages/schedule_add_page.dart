...
class _ScheduleAddPageState extends State<ScheduleAddPage> with TickerProviderStateMixin{
  ...
  void initState(){
    ...
    conditionList = widget.schedule.conditionList;
    actionList = widget.schedule.actionList;
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: MultiHitStack(children: [
          ...
          AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds),
              ...
              child: ClipRect(
                  child: TweenAnimationBuilder<double> (
                      ...
                      duration: Duration(milliseconds: animationDelayMilliseconds),
                      curve: Curves.easeOut,
        ...
        Padding(
            ...
            Column(
              children: [
                ...
                Container(height: 105, child: Align(alignment: Alignment.bottomCenter, child: Text(widget.isScheduleNew? "ADD SCHEDULE" : "EDIT SCHEDULE", style: TextStyle(
                  color: Color(white),
                ...
                Container(height: 55, child: Align(alignment: Alignment.bottomLeft, child: Padding(padding: EdgeInsets.only(left:5, bottom:5), child: Text("Schedule Name", style: TextStyle(
                  color: Color(white),
                  fontFamily: "pretendard",
                  fontWeight: FontWeight.w700,
                  fontSize:20,
                ...
                Container(height: 55, child: Align(alignment: Alignment.bottomLeft, child: Padding(padding: EdgeInsets.only(left:5, bottom:5), child: Text("CONDITIONS", style: TextStyle(
                  color: Color(white),
                  fontFamily: "pretendard",
                  fontWeight: FontWeight.w700,
                  fontSize:20,
                ...
                Stack(children:[
                  ...
                  child: TweenAnimationBuilder<double>(
                    ...
                    builder: (_,opacity,__) {
                      return Center(child: Text(conditionList.getDescription()?? "+CONDITION",style: TextStyle(fontFamily: "pretendard", fontWeight: FontWeight.w700, fontSize: 20, color: conditionList.getDescription() == null? Color(black).withOpacity(opacity) : Color(white).withOpacity(opacity*5)),),);
                    },
                  )
                  ),
                ],),
                Container(height: 55, child: Align(alignment: Alignment.bottomLeft, child: Padding(padding: EdgeInsets.only(left:5, bottom:5), child: Text("ACTIONS", style: TextStyle(
                  color: Color(white),
                  fontFamily: "pretendard",
                  fontWeight: FontWeight.w700,
                  fontSize:20,
                ...
                Stack(children:[
                  ...
                  AnimatedContainer(
                    ...
                    child: TweenAnimationBuilder<double>(
                      ...
                      curve: Curves.easeOut,
                      builder: (_,opacity,__) {
                        return Center(child: Text(actionList.getDescription()?? "+ACTION",style: TextStyle(fontFamily: "pretendard", fontWeight: FontWeight.w700, fontSize: 20, color: actionList.getDescription() == null? Color(black).withOpacity(opacity) : Color(white).withOpacity(opacity*5)),),);
                      },
                    )
                  ),
                ],),
                Container(height: 90, child: Align(alignment: Alignment.bottomCenter, child: Stack(children:[
                  ...
                  GestureDetector(
                    ...
                    ),child: Center(child: Text(widget.isScheduleNew? "ADD SCHEDULE": "EDIT SCHEDULE", style: TextStyle(
                      color: Color(white),
                      fontFamily: "pretendard",
                      fontWeight: FontWeight.w700,
                      fontSize:24,
                ...
                Container(height: 90, child: Align(alignment: Alignment.bottomCenter, child: Stack(children:[
                  ...
                  GestureDetector(
                    ...
                    ),child: Center(child: Text("DELETE SCHEDULE", style: TextStyle(
                      color: Color(white),
                      fontFamily: "pretendard",
                      fontWeight: FontWeight.w700,
                      fontSize:24,
          ...
          Padding(
            ...
            Column(
              children: [
                ...
                Container(height: calculateConditionHeight(), child:
                ClipRRect(
                  borderRadius: BorderRadius.circular(15),
                  child:
        ...
        AnimatedPositioned(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
              top: 350 + calculateConditionHeight() - 60, left: 0, right: 0, child:
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 15),
            child: AnimatedOpacity(opacity: conditionOpen? 1: 0, duration: Duration(milliseconds: animationDelayMilliseconds~/2), child:
              MultiHitStack(
                children: [
                  GestureDetector(
                  ...
                  Container(
                    ...
                    child: Center(child: Text(
                      "+ CONDITIONS",
                      style: pretendard(FontWeight.w700, 20, Color(white)),
                    ))
                  ),
                ],
              ),
          ...
          Padding(
            ...
            Column(
              children: [
                ...
                Container(height: calculateActionHeight(), child:
                ClipRRect(
                  borderRadius: BorderRadius.circular(15),
                  child:
                  ValueListenableBuilder<int>(
        ...
        AnimatedPositioned(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 15),
            child: AnimatedOpacity(opacity: actionOpen? 1: 0, duration: Duration(milliseconds: animationDelayMilliseconds~/2), child:
            MultiHitStack(
              children: [
                GestureDetector(
                  behavior: HitTestBehavior.translucent,
        ...
        return StatefulBuilder(builder: (context, setState) {
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                AnimatedPadding(
                  duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
                          ...
                          children: [
                            GestureDetector(
                                ...
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      ...
                                      content: Column(
                                        children: [
                                          Text("Select Module", style: pretendard(FontWeight.w700, 24, Color(black))),
                                          SizedBox(height: 15,),
                                          GestureDetector(
                                              behavior: HitTestBehavior.translucent,
                                              onTap: (){
                                            ...
                                            Container(height: 60, child: Padding(padding: EdgeInsets.all(15), child: Row(children: [
                                              Expanded(child: Align(alignment: Alignment.centerLeft, child: Text("Time", style: pretendard(FontWeight.w500, 18, Color(black)),))),
                                            ],)))
                                          ),
                                          ...widget.moduleList.comp.map((element) {
                                            return GestureDetector(
                                              ...
                                              Container(height: 60, child: Padding(padding: EdgeInsets.all(15), child: Row(children: [
                                              Expanded(child: Align(alignment: Alignment.centerLeft, child: Text("${element.moduleName}", style: pretendard(FontWeight.w500, 18, Color(black)),))),
                                              Expanded(child: Align(alignment: Alignment.centerRight, child: Text("id: ${element.moduleId}", style: pretendard(FontWeight.w400, 12, Color(black).withOpacity(0.6)),))),
                                            ],)))
                                            );
                                          })
                                        ],
                              ...
                              child: AnimatedContainer(
                                  ...
                                  child: AnimatedPadding(padding: EdgeInsets.only(left: open? 14 : 0), duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, child: Align(alignment: Alignment.centerLeft, child:
                                  AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut,style: pretendard(open? FontWeight.w300 : FontWeight.w500, 32, Color(white)),child: Text(condition.isTimeCondition? "Time" : (module==null? "-" : module!.moduleName)),)))
                              ),
                            ),
                              ...
                              children: [
                                ...
                                if(!condition.isTimeCondition && module != null && module!.type == Module.ONOFF)
                                  GestureDetector(behavior: HitTestBehavior.translucent,
                                    ...
                                    } : null, child: AnimatedContainer(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, width: open?55:32, height: open?35:22, decoration: glassDecoration((condition.target? Color(color2) : Colors.white).withOpacity(open?(condition.target? 0.5 : 0.15):0), (condition.target? Color(color1) : Colors.white).withOpacity(open?(condition.target? 0.5 : 0.05):0), Colors.white.withOpacity(open?0.2:0),shadow: open?1:0),child:
                                    Center(child: AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, style: pretendard(FontWeight.w400, 16, condition.target||!open? Colors.white.withOpacity(open?1:0.6) : Colors.black.withOpacity(0.4)), child:Text(condition.target? "ON" : "OFF"),))),),
                                if(condition.isTimeCondition)
                                  AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
                                    height: open? 100 : 20,
                                    width: 150,
                                    child: Wrap(
                                      runSpacing: 5,
                                      ...
                                      children: [
                                        AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut,style: pretendard(FontWeight.w400, open?24:16, Colors.white.withOpacity(0.6)),child: Text("is")),
                                        AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, width:open? 10 : 2),
                                        GestureDetector(
                                          behavior: HitTestBehavior.translucent,
                                          onTap: open? (){
                                          ...
                                          child: AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
                                              ...
                                              Center(
                                                child: AnimatedDefaultTextStyle(duration: Duration(milliseconds: animationDelayMilliseconds), curve:Curves.easeOut,
                                        ...
                                        AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, width:open? 10 : 2),
                                        AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut,style: pretendard(FontWeight.w400, open?24:16, Colors.white.withOpacity(0.6)),child: Text("to")),
                                        AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, width:open? 7 : 2),
                                        GestureDetector(
                                          behavior: HitTestBehavior.translucent,
                                          onTap: (){
                ...
                AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, height: (module != null && module!.type != Module.ONOFF && open)? 80 : 0, child:
                    Padding(padding: EdgeInsets.only(left: 15, right: 15,), child: FractionallySizedBox(widthFactor: 1, heightFactor: 0.8, child:
                        ...
                        Center(
                          child: FractionallySizedBox(heightFactor: 0.6,widthFactor: 0.95,
                            child: ClipPath(
                              ...
                              child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), gradient: LinearGradient(
                        ...
                        if(module != null && module!.type != Module.ONOFF && open)
                          ...
                          onChange: (fraction){
                            setState((){
                              ...
                              if(firstFraction < secondFraction) condition.setMin = module!.startVal + fraction * (module!.endVal - module!.startVal);
                              else condition.setMax = module!.startVal + fraction * (module!.endVal - module!.startVal);
                            });
                          }, handle: AspectRatio(aspectRatio: 1, child: FractionallySizedBox(widthFactor: 0.8, heightFactor: 0.8, child:
                          Container(decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(100),
                            color: ColorTween(begin: Color(color2), end: Color(color1)).transform(firstFraction),
                            boxShadow: [
                              BoxShadow(
                          ...
                          CustomSlider(initFraction: secondFraction, right: 64.0,
                            onChange: (fraction){
                              setState((){
                                ...
                                if(firstFraction < secondFraction) condition.setMax = module!.startVal + fraction * (module!.endVal - module!.startVal);
                                else condition.setMin = module!.startVal + fraction * (module!.endVal - module!.startVal);
                              });
                            }, handle: AspectRatio(aspectRatio: 1, child: FractionallySizedBox(widthFactor: 0.8, heightFactor: 0.8, child:
                            Container(decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(100),
                              color: ColorTween(begin: Color(color2), end: Color(color1)).transform(secondFraction),
                              boxShadow: [
                              BoxShadow(
                                color: Colors.black.withOpacity(0.1),
                                blurRadius: 10,
                ...
                AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds~/2), curve: Curves.easeOut, height: condition.isTimeCondition&&open? 80:0, child:
                    Padding(
                              ...
                              child: Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  onHorizontalDragUpdate: (info){
                                    ...
                                    else if(changeIndex > 6) changeIndex = 6;
                                  ...
                                  onHorizontalDragEnd: (info) {
                                    draggingWeekDays = false;
                                  },
                                  child: Container(
                                    height: 45,
                                    decoration: glassDecoration(condition.weekDays[index]? Color(color1).withOpacity(0.7) : Colors.white.withOpacity(0.15), condition.weekDays[index]? Color(color2).withOpacity(0.7) : Colors.white.withOpacity(0.05), Colors.white.withOpacity(0.2)),
                                    child: Center(child: AnimatedDefaultTextStyle(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut,
                                        style: pretendard(FontWeight.w400, 16, condition.weekDays[index]? Colors.white : Color(black)), child: Text("${weekDay}"))),
                                  ),
                                ),
                              ),
                            );
                ...
                AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, height: (!condition.isTimeCondition || open)? 0 : 35 ,child:
                Padding(
                ...
                Padding(padding: EdgeInsets.symmetric(horizontal: 15), child: Container(decoration: glassDecoration(Colors.transparent, Colors.transparent, Colors.white.withOpacity(0.2), shadow: 0)),)
              ],
            ),
          );
        });
                                                ...
                                                children: [
                                                  ...
                                                  Container(height: 60, child: Padding(padding: EdgeInsets.all(15), child: Row(children: [
                                                    Expanded(child: Row(children: [
                                                      Expanded(child: Align(alignment: Alignment.centerLeft, child: Text("wait", style: pretendard(FontWeight.w500, 18, Color(black)),))),
                                                      Expanded(child: Align(alignment: Alignment.centerRight, child: Text("Time Delay", style: pretendard(FontWeight.w400, 12, Color(black).withOpacity(0.6)),))),
                                                    ],)),
                                                  ],)))
                                                  ),
                                  ...
                                  if(action.isTimeDelay)
                                    GestureDetector(
                                      ...
                                      child: AnimatedContainer(
                                          ...
                                          decoration: glassDecoration(Colors.white.withOpacity(open? 0.15 : 0), Colors.white.withOpacity(open? 0.05 : 0), Colors.white.withOpacity(open? 0.2: 0), shadow: open?1:0),
                                          child: AnimatedPadding(padding: EdgeInsets.only(left: open? 14 : 0), duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, child: Align(alignment: Alignment.centerLeft, child:
                                          AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut,style: pretendard(open? FontWeight.w300 : FontWeight.w400, open? 32 : 16, Color(white).withOpacity(open? 1 : 0.6)),child: Text("${(action.delaySeconds).toStringAsFixed(1)}"))))
                                      ),
                                    ),
                                  if(action.isTimeDelay)
                                    AnimatedContainer(duration: Duration(milliseconds: animationDelayMilliseconds), curve: Curves.easeOut, width: open? 10 :0),
                                  if(action.isTimeDelay)
                                    AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut,style: pretendard(open? FontWeight.w300 : FontWeight.w400, open? 32 : 16, Color(white).withOpacity(open? 1 : 0.6)),child: Text("seconds")),
                                ],
                              ),
                              Container(height: 5,),
                              Row(
                                ...
                                children: [
                                  ...
                                  if(!action.isTimeDelay && module != null && module!.type == Module.ONOFF)
                                    GestureDetector(behavior: HitTestBehavior.translucent,
                                      ...
                                      } : null, child: AnimatedContainer(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, width: open?55:32, height: open?35:22, decoration: glassDecoration((action.boolValue? Color(color2) : Colors.white).withOpacity(open?(action.boolValue? 0.5 : 0.15):0), (action.boolValue? Color(color1) : Colors.white).withOpacity(open?(action.boolValue? 0.5 : 0.05):0), Colors.white.withOpacity(open?0.2:0),shadow: open?1:0),child:
                                      Center(child: AnimatedDefaultTextStyle(duration:Duration(milliseconds: animationDelayMilliseconds),curve:Curves.easeOut, style: pretendard(FontWeight.w400, 16, action.boolValue||!open? Colors.white.withOpacity(open?1:0.6) : Colors.black.withOpacity(0.4)), child:Text(action.boolValue? "ON" : "OFF"),))),),
                                ],
                              ),
                            ],
                          ),
                    ...
                    MultiHitStack(children: [
                      ...
                      if(module != null && module!.type != Module.ONOFF && open)
                        CustomSlider(initFraction: fraction, right: 64.0,
                          ...
                          Container(decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(100),
                            color: ColorTween(begin: Color(color2), end: Color(color1)).transform(fraction),
                            boxShadow: [
                              BoxShadow(
                                color: Colors.black.withOpacity(0.1),
                                blurRadius: 10,
